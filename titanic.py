"""
Application file rouge mise en prod de projet DataScience.
"""
...
parser = argparse.ArgumentParser(description="Combien d'arbres pour le RandomForest ?")
parser.add_argument(
...
# On _split_ notre _dataset_ d'apprentisage pour la validation croisée
...
# score = le nombre de bonne prédiction
